    ...
    <nav className="bg-white border-gray-200 shadow ">
      <div className="max-w-screen-xl flex mx-auto p-4">
        ...
        <div className="hidden w-full md:flex justify-between" id="navbar-default">
          ...
          <ul className="font-medium ms-auto flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
